...
---
 ...
 - **NLLB-200 Paper:** Costa-jussà, M. R., et al. (2022). _No Language Left Behind: Scaling Human-Centered Machine Translation_. arXiv:2207.04672.
- **OPUS-MT Paper:** Tiedemann, J., & Thottingal, S. (2020). _OPUS-MT – Building open translation services for the World_. EAMT 2020.
- **FastText LID Paper:** Joulin, A., Grave, E., Bojanowski, P., & Mikolov, T. (2016). _Bag of Tricks for Efficient Text Classification_. arXiv:1607.01759.
- **Assessment Specification:** _IncuBrix Track 04 Candidate Project Assessment - Multilingual Translation with Independent Quality Control_ (SASTRA 2027).
